...
export default function WorkInProgress({ size = 24 }: Props) {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 42" width={size} height={size} fill="currentColor" focusable="false">
